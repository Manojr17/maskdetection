...
cnn=models.Sequential([
    layers.Convo2D(filters=32, kernel_size=(3,3), activation ="relu" ,
                   input_shape=(256 , 256 , 3)),
    layers.MaxPooling2D((2,2)),

    layers.Convo2D(filters=64, kernel_size = (3,3),activation="relu"),
    layers.MaxPooling2D((2,2)),
...
while True:
    ...
    if flag:
        ...
        for x ,y, w, h in face:
            cv2.rectange(img,(x , y),(w+x,h+y),(255,0,255),4)
